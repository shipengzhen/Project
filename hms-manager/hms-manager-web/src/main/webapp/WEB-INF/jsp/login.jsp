...
.login-box .remember label{display:inline-block;height:42px;width:200px;line-height:34px;text-align:left}
...
<div class="login-box">
	...
	<form method="post" action="doLogin">
		<div class="name">
			<label>管理员账号：</label>
			<input type="text" name="loginId" id="" tabindex="1" autocomplete="off" />
		</div>
		<div class="password">
			<label>密  码：</label>
			<input type="password" name="loginPwd" maxlength="16" id="" tabindex="2"/>
		</div>
		<div class="remember">
