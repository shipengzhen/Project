...
<body>
<form action="/HMS/doAddCostItem" id="addCostItem" method="post" class="definewidth m20">
<table class="table table-bordered table-hover definewidth m10">
    <tr>
        <td width="10%" class="tableleft"><font color="red">*</font>收费项目名称</td>
        <td><input type="text" name="costitemname" value="" /><span class="dd"></span></td>
    </tr>

    <tr>
        <td width="10%" class="tableleft"><font color="red">*</font>收费金额</td>
        <td><input type="text" name="cost" value=""/><span class="dd"></span></td>
    </tr>
    <tr>
        <td colspan="2">
			<center>
