	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="admin/main"> <img alt="Charisma Logo" src="statics/img/logo20.png" /> <span>SL会员商城</span></a>
				<div class="btn-group pull-right" >
					<ul class="nav">
						<li><a href="#">你好，${User.loginname}</a></li>
						<li><a href="#">角色：${User.roleName}</a></li>
						<li><a href="admin/main">首页</a></li>
						<li><a href="user/shopingCard">购物车</a></li>
						<li><a href="admin/logon">注销</a></li>
					</ul>
				</div>
