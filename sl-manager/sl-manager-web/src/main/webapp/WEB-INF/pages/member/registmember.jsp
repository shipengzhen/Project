	...
	<ul class="breadcrumb">
		...
		<li><a href="/member/registmember.html">会员注册</a></li>
			...
			<div class="row-fluid sortable">		
				...
				<form action="admin/doAddUserByZC" enctype="multipart/form-data" method="post" onsubmit="return registMemberFunc();">
					<div class="member-modal-body">
						<ul id="add_formtip"></ul>
						<ul class="topul">
							<li>
							  <label>用户名：</label>
							  <input type="text" id="a_loginCode" name="loginname" placeholder="字母和数字6~12位"  onkeyup="value=value.replace(/[^\w\.\/]/ig,'')"/>
							  <span style="color:red;font-weight: bold;">*</span>
							</li>
							<li>
							  <label>姓名：</label>
							  <input type="text" id="a_userName" name="uname"/>
							  <span style="color:red;font-weight: bold;">*</span>
							</li> 
							<li>
							  <label>性别：</label>
							...
							<li>
							  ...
							  <select id="a_cardType" name="cardtypeid" style="width:100px;">
					 			<option value="" selected="selected">--请选择--</option>
						...
						<!-- 	<li>
							...
							<li>
							  <label>邮政编码：</label>
							  <input type="text" id="a_postCode" name="postalcode" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"/>
							</li>
							<li>
							  <label>开户行：</label>
							...
							<li>
							  <label>开户卡号：</label>
							  <input type="text" id="a_bankAccount" name="banknumber" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"/>
							  <span style="color:red;font-weight: bold;">*</span>
							</li>
							<li>
							  <label>开户人：</label>
							  <input type="text" id="a_accountHolder" name="bankuname"/>
							  <span style="color:red;font-weight: bold;">*</span>
							</li>
							<li>
							  <label>是否启用：</label>
...
<script type="text/javascript" src="statics/localjs/registmember1.js"></script> 