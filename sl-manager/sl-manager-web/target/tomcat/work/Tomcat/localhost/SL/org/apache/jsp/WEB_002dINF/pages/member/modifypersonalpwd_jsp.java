 ...
 * Generated at: 2018-04-04 01:50:01 UTC
...
public final class modifypersonalpwd_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t<li><a href=\"/member/modifypersonalpassword.html\">修改本人密码</a></li>\r\n");
      out.write("\t</ul>\r\n");
      out.write("</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t<h2><i class=\"icon-user\"></i>修改密码</h2>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"box-content\">\r\n");
      out.write("\t\t\t\t\t<div class=\"modal-body\">\r\n");
      out.write("\t\t\t\t\t\t<ul class=\"topul\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"modal-header\">\r\n");
      out.write("\t\t\t\t\t\t\t<h3>修改商城登录密码</h3>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"member-modal-body\">\r\n");
      out.write("\t\t\t\t\t\t<p>\r\n");
      out.write("\t\t\t\t\t\t\t\t<label>请输入原密码：</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t  <input id=\"oldloginpwd\"  type=\"password\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t  <span style=\"color:red;font-weight: bold;\">*</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t<label>请输入新密码：</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t  <input id=\"newloginpwd\"  type=\"password\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t  <span style=\"color:red;font-weight: bold;\">*新密码必须6位以上</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t<label>再次输入新密码：</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t  <input id=\"againloginpwd\"  type=\"password\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t  <span style=\"color:red;font-weight: bold;\">*</span>\r\n");
      out.write("\t\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t\t\t<p id=\"modifyloginpwdtip\">\r\n");
      out.write("\t\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<a href=\"#\" id=\"saveloginpwd\" class=\"btn btn-primary\">保存</a>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t<div class=\"box-content\">\r\n");
      out.write("\t\t\t\t\t<div class=\"modal-body\">\r\n");
      out.write("\t\t\t\t\t\t<ul class=\"topul\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"modal-header\">\r\n");
      out.write("\t\t\t\t\t\t<h3>修改商城二级密码</h3>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"member-modal-body\">\r\n");
      out.write("\t\t\t\t\t\t<p>\r\n");
      out.write("\t\t\t\t\t\t\t\t<label>请输入原密码：</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t  <input id=\"oldsecondpwd\"  type=\"password\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t  <span style=\"color:red;font-weight: bold;\">*</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t<label>请输入新密码：</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t  <input id=\"newsecondpwd\"  type=\"password\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t  <span style=\"color:red;font-weight: bold;\">*新密码必须6位以上</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t<label>再次输入新密码：</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t  <input id=\"againsecondpwd\"  type=\"password\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t  <span style=\"color:red;font-weight: bold;\">*</span>\r\n");
      out.write("\t\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t\t\t<p id=\"modifysecondpwdtip\">\r\n");
      out.write("\t\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<a href=\"#\" id=\"savesecondpwd\" class=\"btn btn-primary\" id=>保存</a>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t</div><!--/span-->\r\n");
      out.write("\t\t\t\r\n");
      ...
      out.write("\t</html>");
      out.write("\r\n");
      out.write("<script type=\"text/javascript\" src=\"statics/localjs/modifypersonalpwd1.js\"></script> \r\n");
