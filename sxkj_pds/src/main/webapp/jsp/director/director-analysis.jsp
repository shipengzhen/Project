...
<script>
    ...
    select.onchange = function () {
        ...
        switch (selvalue) {
            case "labb" :
                val.innerHTML = "<option>重点实验室</option><option>临床医学研究中心</option><option>创新药物研究中心</option><option>工程技术研究中心</option><option>药用植物示范基地</option><option>";
                break;
            case "labc" :
                val.innerHTML = "<option>高新区</option><option>可持续发展实验室</option><option>农业科技园</option><option>县城科技创新实验示范站</option>";
                break;
            case "labd" :
                val.innerHTML = "<option>科技资源开放共享平台</option>";
                break;
            case "labe" :
                val.innerHTML = "<option>省软科学研究基地</option>";
                break;

            case "labf" :
                val.innerHTML = "<option>科技企业孵化器、众创空间</option><option>星创天地</option>";
                break;
            case "labg" :
                val.innerHTML = "<option>科技成果转化引导基金管理服务平台</option>";
                break;
            case "labh" :
                val.innerHTML = "<option>校企共建新型研发平台</option><option>技术转移示范机构</option><option>技术合同认定登记机构</option>";
                break;

            case "labi" :
                val.innerHTML = "<option>国际科技合作基地</option>";
                break;
        }
    };
</script>
