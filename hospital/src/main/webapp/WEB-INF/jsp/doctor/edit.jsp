...
<body>
<form action="../doctor/index.jsp" method="post" class="definewidth m20">
<table class="table table-bordered table-hover definewidth m10">
    ...
    <tr>
        <td colspan="2">
			<center>
				<input type="submit" class="btn btn-primary" value="保存"> &nbsp;&nbsp;<input type="button" class="btn btn-success" name="backid" id="backid" value="返回列表">
			</center>
		</td>
    </tr>
</table>
