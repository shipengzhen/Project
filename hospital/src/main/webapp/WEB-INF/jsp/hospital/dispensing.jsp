    ...
    <script type="text/javascript">
	 $(function () {
		$('#newNav').click(function(){
				window.location.href="sys/bxd/hospitaldispensing-gives";
		 });
    });
    ...
    <tr>
        ...
        <th>操作</th>
	     ...
	     <tr >
            ...
            <td style="vertical-align:middle;"><a href="sys/bxd/hospitaldispensing-give">发药</a>&nbsp;&nbsp;&nbsp;<a href="sys/bxd/hospitaldispensing-look">详情...</a></td>
        </tr>
