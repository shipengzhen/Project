    ...
    <script type="text/javascript">
	 $(function () {
		$('#newNav').click(function(){
				window.location.href="sys/bxd/hospitaladd";
		 });
    });
    ...
    <tr>
        ...
        <th>操作</th>
	     ...
	     <tr >
            ...
            <td style="vertical-align:middle;">周莎莎</td>
            ...
            <td style="vertical-align:middle;">
				<a href="sys/bxd/hospitallook">详情</a>&nbsp;&nbsp;&nbsp;
				<a href="sys/bxd/hospitaledit">更改</a>&nbsp;&nbsp;&nbsp;
				<a href="sys/bxd/hospitaladd_many">缴纳押金</a>&nbsp;&nbsp;&nbsp;				
			</td>
        </tr>
	     <tr >
         	<td style="vertical-align:middle;"><input type="checkbox" name="check" value="1"></td>
