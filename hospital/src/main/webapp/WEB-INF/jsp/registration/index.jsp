...
<head>
	...
	<script type="text/javascript" src="staics/Js/jquery.table2excel.min.js"></script>
    <style type="text/css">
        body {
            padding-bottom: 40px;
        }
    ...
    <script type="text/javascript">
	 $(function () {
		$('#newNav').click(function(){
				window.location.href="sys/bxd/registrationadd";
		 });
    });
    	function checkall(){
...
<table class="table table-bordered table-hover definewidth m10" id="bxd">
    <tr>
...
<table class="table table-bordered table-hover definewidth m10" id="bdd" >
   <thead>
    <tr>
        ...
        <th>操作</th>
	     ...
	     <tr >
            ...
            <td style="vertical-align:middle;"><a href="sys/bxd/registrationlook">详情</a>&nbsp;&nbsp;&nbsp;<a href="sys/bxd/registrationedit">更改</a>&nbsp;&nbsp;&nbsp;<a href="javascript:alert('退号成功！');">退号</a></td>
        </tr>
	     <tr >
         	<td style="vertical-align:middle;"><input type="checkbox" name="check" value="1"></td>
            ...
            <td style="vertical-align:middle;"><a href="/sys/bxd/registrationlook">详情>>></a>&nbsp;&nbsp;&nbsp;<a href="edit.html">更改</a></td>
        </tr>
	     <tr >
         	<td style="vertical-align:middle;"><input type="checkbox" name="check" value="1"></td>
  ...
  <table class="table table-bordered table-hover definewidth m10" id="bxd">
  	<tr><th colspan="5">  <div class="inline pull-right page">
		 ...
		 <button type="button" class="btn btn-success" id="tableid" onclick="method();">导出Excel</button>
		 </div>
		 </th></tr>
  </table>
</body>
